        ...
        do {
            try {
                ...
                if (checkClient(message)) {
                    ...
                    if (message.contains("INSERT") && message.contains("users")) {
                    ...
                    } else if ((message.contains("UPDATE") || message.contains("DELETE")) && message.contains("devices")) {
                        logger.log(Level.INFO, "UPDATE|DELETE DEVICE HANDLER");
                        ...
                        if (message.contains("DELETE")) {
                            // return
                            // delete
                            parts = ApiTransmitter.retrieveReturnDevice(message, outputStream, sqlHandler, cryptoHandler, logger);
                            outputStream.flush();
                            sqlHandler.updateHandler(message);
                        } else {
                            // update
